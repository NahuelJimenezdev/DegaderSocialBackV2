/**
 * Script de utilidad para asignar rol de moderador a un usuario
 * 
 * Uso:
 * node src/scripts/setModeratorRole.js <email_del_usuario>
 * 
 * Ejemplo:
 * node src/scripts/setModeratorRole.js usuario@ejemplo.com
 */
...
async function setModeratorRole(email) {
    try {
        ...
        console.log(`   Nuevo rol: moderador`);
        console.log(`   Permisos de moderación: ✓`);
...
if (!email) {
    ...
    console.log('\nUso:');
    console.log('  node src/scripts/setModeratorRole.js <email_del_usuario>');
    console.log('\nEjemplo:');
    console.log('  node src/scripts/setModeratorRole.js usuario@ejemplo.com');
    process.exit(1);
}
